...
const TOTAL_RECT = 64;
const MobileDiagonalLines = ({ isHover }: { isHover: boolean }) => {
  ...
  return (
    <div
      className={cx(
        "relative h-full w-full flex items-center justify-center overflow-hidden opacity-1",
        { "opacity-1": isShow },
        { "opacity-0": !isShow }
      )}
      style={{
...
export default MobileDiagonalLines;
