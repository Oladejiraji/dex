        ...
        >
          <div className="relative mx-auto h-fit w-full max-w-[29.38rem] p-[0.06rem]">
            ...
            <div className="select_gradient relative flex flex-1 flex-col rounded-[0.38rem]">
              <div className="flex items-center justify-between rounded-t-[0.63rem] bg-[#0D0E0F] px-5 py-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <Select
                      ...
                      className="h-10 w-[10.81rem] gap-0 rounded-[0.38rem] border border-solid border-[#272727] font-geist-medium text-[0.94rem] text-[#AFAFAF]"
                ...
                <div className="flex items-center gap-[0.88rem] pt-4">
                  {presetSlippageOptions.map((option) => {
                    return option.editable ? (
                      <div key={option.id} className="relative font-geist-medium text-[0.94rem] text-[#5F5F5F]">
                        <input
                          type="number"
                          className={cn(
                            'h-[3.13rem] w-[15.88rem] rounded-[0.38rem] border-[0.5px] border-[#272727] bg-[#0F0F0F] px-2',
                            {
                      ...
                      <button
                        ...
                        key={option.id}
                        className={cn(
                          'flex h-[3.13rem] w-[2.88rem] cursor-pointer items-center justify-center rounded-[0.38rem] border-[0.5px] border-[#272727] bg-[#0F0F0F] font-geist-medium text-[0.94rem] text-[#AFAFAF] transition',
                          {
