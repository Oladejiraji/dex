  ...
  return (
    <>
      ...
      >
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">Introduction</h1>
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">Acceptance of Terms</h1>
          <p className="font-geist-medium text-[0.94rem]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">1. DEFINITIONS</h1>
          <p className="font-geist-medium text-[0.94rem]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">2. ELIGIBILITY</h1>
          <p className="font-geist-medium text-[0.94rem]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">3. SERVICES</h1>
          <p className="font-geist-medium text-[0.94rem]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">5. FEES</h1>
          <p className="font-geist-medium text-[0.94rem]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">9. TERMINATION</h1>
          <p className="font-geist-medium text-[0.94rem]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[1.13rem]">10. PRIVACY POLICY</h1>
          <p className="font-geist-medium text-[0.94rem]">
