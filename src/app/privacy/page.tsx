  ...
  return (
    <>
      ...
      >
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[18px]">3. DATA SHARING</h1>
          <ul className="list-disc ml-4">
            <li className="font-geist-medium text-[15px]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[18px]">4. SECURITY</h1>
          <p className="font-geist-medium text-[15px]">
        ...
        <div className="pb-6">
          <h1 className="font-geist-medium text-[18px]">5. YOUR RIGHTS</h1>
          <p className="font-geist-medium text-[15px]">
