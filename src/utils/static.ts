...
export const faqData = [
  ...
  },
  {
    ...
    answer: 'No we do not, any fees incurred are either gas fees or bridging fees.',
  },
  {
    id: 5,
    question: 'What chains and bridges does Superbase support?',
    answer: 'Superbase supports a variety of bridges and chains, with more coming soon, view supported chains here.',
  },
  {
    id: 6,
    question: 'Can I bridge on Superbase?',
    answer: 'This depends on our backend engineer @Oladeji is it safe to bridge on superbase.',
  },
];
